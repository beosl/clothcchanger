...
async def generate_outfit_image(character_image: str, outfit_image: str, outfit_name: str, parts: List[str], settings: Dict) -> str:
...
async def apply_dressing(request: DressingRequest):
    ...
    result_image = await generate_outfit_image(
